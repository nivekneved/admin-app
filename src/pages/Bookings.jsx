...
const Bookings = () => {
  const [bookings, setBookings] = useState([
    { id: 1, customer: 'Alex Johnson', date: '2023-07-15', lounge: 'Premium Lounge A', duration: '4 hours', status: 'Confirmed' },
    { id: 2, customer: 'Maria Garcia', date: '2023-07-18', lounge: 'Business Lounge', duration: '2 hours', status: 'Pending' },
    { id: 3, customer: 'David Wilson', date: '2023-07-20', lounge: 'VIP Lounge', duration: '6 hours', status: 'Confirmed' },
    { id: 4, customer: 'Sophia Chen', date: '2023-07-22', lounge: 'Premium Lounge B', duration: '3 hours', status: 'Cancelled' },
  ]);
